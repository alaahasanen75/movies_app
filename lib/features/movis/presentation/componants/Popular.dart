...
class PopularWidgit extends StatelessWidget {
  const PopularWidgit({super.key});
    ...
    return BlocConsumer<MovisCubit, MovisState>(
      builder: (context, state) {
        ...
        return ConditionalBuilder(
          condition: state is! MovisPopLoadingState,
          builder: (context) {
            return FadeIn(
              ...
              child: SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemCount: cubit.resultePopular.length,
                        ...
                        child: ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            ...
                            imageUrl: AppConstant.UrlImg(
                                cubit.resultePopular[index].img),
